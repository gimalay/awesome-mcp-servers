...
- <img src="https://iwe.md/favicon.png" height="14"/> [IWE](https://github.com/iwe-org/iwe) - Turn a local directory of markdown notes into a knowledge graph. Agents search, retrieve, create, and refactor the same plain files you edit in your editor; stdio and streamable HTTP transports.
